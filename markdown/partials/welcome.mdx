...
article [here][pretty-mean-deck].

If you are new to the archetype then please check out the [FAQs Appendix][faq]
for any initial queries you might have. Please peruse the wiki, have a read of
some of the articles and if after going through you still have questions then
feel free to come visit us in the [Discord][discord].
